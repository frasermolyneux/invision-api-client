...
{
    public class ForumsApi : BaseApi, IForumsApi
    {
        public ForumsApi(ILogger<ForumsApi> logger, IOptions<InvisionApiClientOptions> options, TelemetryClient telemetryClient) : base(logger, options, telemetryClient)
        {
        }
